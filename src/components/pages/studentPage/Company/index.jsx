...
import { Search_bar } from "../styled.jsx";
        ...
        <>
            ...
            <Out_box>
                ...
                <Grid_box>
                    {
                        IC_data ?
                            IC_data.map((Data) => <IC_View IC_data={Data} key={Data.companyId} />)
                            :
                            <></>
                    }
                </Grid_box>
                    ...
                    <Page_bar>
                        ...
                        </Small_box>
                        {
                            IC_data ?
                                Click_page().map((data) => {
                                    if (data.circle) {
                                        return <Circle_btn onClick={() => setPage(data.id)} key={data.id}>{data.id}</Circle_btn>
                                    } else {
                                        return <UnCircle_btn onClick={() => setPage(data.id)} key={data.id}>{data.id}</UnCircle_btn>
                                    }
                                }) :
                                <></>
                        }
