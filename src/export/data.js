  ...
  content: [
    {
      ...
      detailBusinessDescription:
        "시스템의 안정성과 확장성을 확보하는 한편, 최신 기술을 도입을 통한 진화하는 아키텍쳐 유지 엔지니어링팀의 기술적인 방향성 및 디자인/코드 리뷰를 통한 건강한 개발 문화 제시",
      numberOfEmployee: 4,
      gradeCutLine: 50,
      applicantCount: 9,
    ...
    //     name: "보안동아리",
    //   },
    //   detailBusinessDescription: `이상적인 지원자는 3년 이상의 웹 프론트엔드 개발 경험을 지닌 분으로, React 기반의 프레임워크 및 디자인과의 협업에 능숙한 분입니다. 사용자 경험에 큰 임팩트를 주는 역할인 만큼, 디자인에 관한 디테일을 놓치지 않는 분이길 기대합니다.`,
    //   numberOfEmployee: 1,
    //   gradeCutLine: 30,
    //   applicantCount: 9,
    //   isPersonalContact: false,
    ...
    //     name: "보안동아리",
    //   },
    //   detailBusinessDescription: `주요 업무로는 데이터베이스 구축, 운영 관리, 모니터링, 튜닝 등의 업무가 있으며, 사용하는 데이터베이스는 SQL SERVER, MYSQL, REDSHIFT등이 있습니다. 원할한 업무 진행을 위해 해당 기술과 경험이 있었으면 좋겠습니다.`,
    //   numberOfEmployee: 2,
    //   gradeCutLine: 20,
    //   applicantCount: 9,
    //   isPersonalContact: false,
    ...
    //     name: "보안동아리",
    //   },
    //   detailBusinessDescription: `신규 사업 전략을 설계하고, 필요한 제품과 서비스를 제공할 수 있는 업체와 제휴를 맺어 함께 사업을 실행해가실 분을 찾습니다.`,
    //   numberOfEmployee: 1,
    //   gradeCutLine: 10,
    //   applicantCount: 9,
    //   isPersonalContact: false,
    ...
    //     name: "보안동아리",
    //   },
    //   detailBusinessDescription: `아이디어스 서비스 내 다양한 영역의 추천 서비스 연구 및 개발`,
    //   numberOfEmployee: 4,
    //   gradeCutLine: 70,
    //   applicantCount: 9,
    //   isPersonalContact: false,
    ...
    //     name: "보안동아리",
    //   },
    //   detailBusinessDescription: `교육 시장 리서치 및 기획을 위한 분석 리포트 작성`,
    //   numberOfEmployee: 2,
    //   gradeCutLine: 30,
    //   applicantCount: 9,
    //   isPersonalContact: false,
    ...
    //     name: "보안동아리",
    //   },
    //   detailBusinessDescription: `반다이남코그룹은 상품과 서비스를 통해 꿈, 놀이, 감동을 제공하는 것을 미션으로 삼고, 비전인 ‘세계에서 가장 기대되는 엔터테인먼트 기업 그룹’이 되는 것을 목표로 하고 있습니다.
    //     반다이남코코리아는 프라모델, 피규어, 완구, 잡화, 게임 사업 등 다양한 사업을 전개하고 있으며 고객과 직접 만날 수 있는 전국의 ‘건담 베이스’, 온라인 공식 쇼핑몰 ‘반다이남코코리아몰’ 등의 운영도 함께하고 있습니다.`,
    //   numberOfEmployee: 2,
    //   gradeCutLine: 50,
    //   applicantCount: 9,
    //   isPersonalContact: false,
    ...
    //     name: "보안동아리",
    //   },
    //   detailBusinessDescription: `국가별 독립적인 애플리케이션 개발합니다. 고객 중심의 UI/UX를 개선하고 사용자 경험과 데이터의 상호작용을 관리합니다.`,
    //   numberOfEmployee: 1,
    //   gradeCutLine: 10,
    //   applicantCount: 9,
    //   isPersonalContact: false,
    ...
    //     name: "보안동아리",
    //   },
    //   detailBusinessDescription: `K Car는 ”고객과의 신뢰”를 최고의 가치로 여기고, 중고차 시장의 신뢰도와 투명성을 높이는데 앞장섭니다. K Car만의 진단전문성과 보증서비스, 체계화된 시스템을 통하여 중고차 유통시장의 변화를 주도합니다. 앞으로도 K Car는 고객과의 신뢰와 편리(Trust & Easy)를 최우선으로 하여 세계최고의 중고차 기업으로 성장해 나갈 것입니다.`,
    //   numberOfEmployee: 3,
    //   gradeCutLine: 40,
    //   applicantCount: 9,
    //   isPersonalContact: false,
    ...
    //     name: "보안동아리",
    //   },
    //   detailBusinessDescription: `토스의 안팎에서 다양한 웹 서비스를 개발합니다. 앱 내에서는 토스 신용카드, 내 보험 조회와 같이 빠른 개발 주기의 제품들을 담당합니다. 앱 밖에서는 행운퀴즈와 같이 토스 앱과 연계되는 다양한 서비스를 개발합니다. 완벽한 사용자 경험을 목표로 프론트엔드 개발 환경을 개선하고, TDS 등 토스 공통 라이브러리 제작에 참여합니다.`,
    //   numberOfEmployee: 1,
    //   gradeCutLine: 25,
    //   applicantCount: 9,
    //   isPersonalContact: false,
    ...
    //     name: "보안동아리",
    //   },
    //   detailBusinessDescription: `야놀자 및 야놀자멤버사의 방대하고 복잡한 데이터로부터 새로운 가치와 성장을 창출합니다. 문제를 해결하기 위해, 데이터 수집, 요구사항 정의, 데이터 처리, 분석, 모델링, 적용 과정에서 분석하고 계획을 수립합니다. 야놀자 내부의 데이터 형식, 인프라스트럭쳐등을 활용하여, 분석, 모델링을 할 수 있는, 파이프라인의 프로토타입을 정립합니다. 다양한 팀과 협업을 통해, 다양한 야놀자 비즈니스 (예, 다이나믹 프라이싱, 검색, 인벤토리 관리 등) 영역(직군)의 이해관계자에게, 정량적인 분석을 통하여 최적의 결정을 내릴 수 있도록 도와줍니다. 야놀자의 사용자가 직접 경험할 수 있는 제품에 맞추어 분석, 예측, 최적화 모델을 연구하고 개발합니다.`,
    //   numberOfEmployee: 3,
    //   gradeCutLine: 80,
    //   applicantCount: 9,
    //   isPersonalContact: false,
    ...
    //     name: "보안동아리",
    //   },
    //   detailBusinessDescription: `신상품 상세페이지를 디자인합니다. 신상품 연출을 기획합니다. 촬영 및 이미지 보정, 목업 디자인을 진행합니다. 비즈하우스 상품 템플릿을 디자인합니다.`,
    //   numberOfEmployee: 2,
    //   gradeCutLine: 50,
    //   applicantCount: 9,
    //   isPersonalContact: false,
    ...
    //     name: "보안동아리",
    //   },
    //   detailBusinessDescription: `IDC 인프라 구축 및 운영(Linux) 클라우드 인프라 구축 및 운영(AWS/MS-Azure/NHN Cloud) 시스템 분석 및 성능 튜닝, 최적화 모니터링 시스템(zabbix/icinga/Prometheus) 개발/운영`,
    //   numberOfEmployee: 3,
    //   gradeCutLine: 55,
    //   applicantCount: 9,
    //   isPersonalContact: false,
    ...
    //     name: "보안동아리",
    //   },
    //   detailBusinessDescription: `GS리테일의 전략적 피투자사의 손익 및 이슈 관리를 통해 지속 성장을 지원하고 당사와의 전략적 시너지 창출을 위한 협업을 기획/추진하는 facilitor로서의 R&R 갖고 있습니다.`,
    //   numberOfEmployee: 5,
    //   gradeCutLine: 30,
    //   applicantCount: 9,
    //   isPersonalContact: false,
    ...
    //     name: "보안동아리",
    //   },
    //   detailBusinessDescription: `VOC를 관리/분석하고 서비스를 개선하기 위해 유관부서와 협업 작품 메타데이터 입력 및 작품 업로드를 진행 작품 서비스 관련 일정 및 업무 조율 커뮤니티 관리 및 작품 관련 데이터 확인 및 개선 특별 상영회, 성우 팬미팅 등 작품 관련 다양한 오프라인 행사 기획 및 운영지원`,
    //   numberOfEmployee: 2,
    //   gradeCutLine: 25,
    //   applicantCount: 9,
    //   isPersonalContact: false,
