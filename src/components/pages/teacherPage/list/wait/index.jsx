...
import { Table } from "../../../companyPage/requestResistration/style";
const Wait = ({ path }) => {
                  ...
                  {data.count.map((user, i) => (
                    <Libox>
                      <Box>
                        ...
                        <ButtonProps>
                          {path === "/notice/waiting-list" ? (
                            <>
                              <MainBtn
                                top={-40}
                                onClick={() =>
                                  navigate(`/teacher/list/${user.id}`)
                                }
                              ...
                              <p>
                                {data.content[i].noticeOpenPeriod.startDate}
                              </p>
                            </>
                          ) : (
                            <>
